...
export const MessageManager = (props: MessageManagerProps) => {
    ...
    const sender = useRef(new MessageSender(chatService))
    const receiver = useRef(new MessageReceiver(chatService))
    sender.current.setCallback(data => {
        setMyMessages(myMessages.concat(data))
    })
    receiver.current.setCallback(data => {
...
export class MessageReceiver {
    ...
    private onReceive(data: MessageDTO) {
        ...
        if (this._receivedCallback) this._receivedCallback(data)
    }
...
export class MessageSender {
    ...
    private onSended(data: MessageDTO) {
        ...
        if (this._sendCallback) this._sendCallback(data)
    }
